...
try:
    from ADCDACPIo import ADCDACPi
except ImportError:
...
if __name__ == '__main__':
        ...
        while True:
            ...
            if (time_count % 5000) == 0:
                # Pressure Check
                sensor_val1_1 = adcdac.read_adc_voltage(1, 1)
                sensor_val1 = (3.3 * (sensor_val1_1 -9) / (3322 - 9)) 
              
                sensor_val2_2 = adcdac.read_adc_voltage(2, 1)
                sensor_val2 = (3.3 * (sensor_val2_2 -10) / (3322 - 10)) 
